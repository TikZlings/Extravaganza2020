...
\begin{scope}[yshift=0.75cm,xshift = 5.5cm]
   ...
   \node at (0.0,0.6) {\includegraphics[width=1cm]{colt}};
\end{scope}
\begin{scope}[yshift=-5.25cm,xshift=-50+0.54*\thepage,yscale=0.7]
  ...
  \node[rotate=20] at (-0.6,0.7) {\includegraphics[width=1cm]{bottle}};  
\end{scope}
\pause[500]
\end{tikzpicture}
\end{frame}
...
\begin{scope}[yshift=0.75cm,xshift = 5.5cm]
    ...
    scale=0.8,
		bubblecolour=gray!30!white];
   \node[ellipse callout,fill=white!80!gray,callout absolute pointer={(0.8,1.4)}] at (2.8,2) {Call me James}; 
   \node at (0.0,0.6) {\includegraphics[width=1cm]{colt}};
\end{scope}
