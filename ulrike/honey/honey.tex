...
% delay 35 => 100/35 FPS 
% Needed: 25 FPS
% => increase number of pages by 25/(100/35) = 8.75
% => decrease tikz stepsize to 50/8.75 = 5.714
...
{0,5.714,...,4000}
{
  \only<+>{%
    ...
    \node[] at ([yshift=2.5mm,xshift=0.9cm]beartummy) {\includegraphics[trim=0cm 0cm 0.7cm 0cm,clip,width=2cm,angle=20]{spoon}};
    \end{scope}
}}
\end{tikzpicture}
\end{frame}
